...
**root** : _Array_
|-> **Item** : _Dictionary_
____|-> **name**: _String =_ _MapZone_
____|-> **parameters**: _Array_
________|-> **Item**: _Dictionary_
____________|-> **name**: _String_ = _position_

**We use:**
**root** : _Dictionary_
|-> **MapZone** : _Dictionary_
____|-> **parameters** : _Dictionary_
________|-> **position** : _Dictionary_
